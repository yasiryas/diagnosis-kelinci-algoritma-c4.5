...
class miningModel extends Model
{
    ...
    public function deleteMiningSamplePenyakit($id_penyakit)
    {
        $sql = "DELETE FROM mining_sample WHERE id_penyakit= $id_penyakit";
        $this->db->query($sql);
    }

    public function deleteMiningSampleGejala($id_gejala)
    {
