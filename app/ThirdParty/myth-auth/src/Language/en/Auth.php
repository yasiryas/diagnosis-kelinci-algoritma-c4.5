...
return [
    ...
    // Password Change
    'changeDisabled'            => 'Changing password option has been disabled.',
    'changeNoUser'              => 'Unable to locate a user with that email.',
    'changeSubject'             => 'Password Change Instructions',
    'changeSuccess'              => 'Your password has been successfully changed. Please login with the new password.',
    'changeEmailSent'           => 'A security token has been emailed to you. Enter it in the box below to continue.',
    'errorEmailSent'            => 'Unable to send email with password change instructions to: {0}',
    'errorResetting'            => 'Unable to send change instructions to {0}',
