                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= route_to('forgot') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php endif ?> form-control-user" name="email" aria-describedby="emailHelp" placeholder="<?= lang('Auth.email') ?>">
                                    </div>
                                ...
                                <div class="text-center">
                                    <?php if ($config->allowRegistration) : ?>
                                        <p><a class="small" href="<?= route_to('register') ?>"><?= lang('Auth.needAnAccount') ?></a>
                                        <?php endif; ?><br>
